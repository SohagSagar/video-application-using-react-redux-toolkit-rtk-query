...
export default function Form({ video }) {
    const {id,title:initialTitle,description:initialDescription,author:initialauthor,date:initialDate,duration:initialDuration,views:initialViews,link:initialLink,thumbnail:initialThumnail}= video;
    ...
    const [thumbnail, setThumbnail] = useState(initialThumnail);
    ...
    return (
        <form onSubmit={handleSubmit} method="POST">
            <div className="shadow overflow-hidden sm:rounded-md">
                ...
                {
                    isSuccess ? <Success message="Video was added successfully" /> : isError && <Error />
                }
            </div>
        </form>
    );
